...
def build_dataset_train(dataset, input_size, batch_size, train_type, random_scale, random_mirror, num_workers):
    #data_dir = os.path.join('../cyl/orDABNet-master/dataset/', dataset)
    #data_dir = os.path.join('/tmp/cyl/DABNet-master/dataset/', dataset)
    #data_dir = os.path.join('/tmp/mst/DABNet-master/dataset/', dataset)
    data_dir = os.path.join('/home/shuxue3/mst/', dataset)
    dataset_list = os.path.join(dataset, '_trainval_list.txt')
    #train_data_list = os.path.join(data_dir, dataset + '_' + train_type + '_list.txt')
    train_data_list = os.path.join('/home/shuxue3/mst/DABNet-master/dataset/', dataset, dataset + '_' + train_type + '_list.txt')
    #val_data_list = os.path.join(data_dir, dataset + '_val' + '_list.txt')
    val_data_list = os.path.join('/home/shuxue3/mst/DABNet-master/dataset/', dataset, dataset + '_val' + '_list.txt')
